...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DiscountTypeIsNotSupportedException.class)
    public ResponseEntity<String> handleDiscountTypeIsNotSupportedException(DiscountTypeIsNotSupportedException ex) {
